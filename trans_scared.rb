...
# ===== 新しいテクノビート =====
##| live_loop :dark_kick do; t = vt; if t > 30; intensity = [(t - 30) / 60.0, 1.5].min; with_fx :reverb, room: 0.4, mix: 0.3 do; with_fx :lpf, cutoff: 70 do; sample :bd_boom, amp: 0.7, rate: 0.7, cutoff: 60, attack: 0.01, release: 0.8; end; end; sleep 10; if one_in(25); sample :bd_808, amp: 0.45 + intensity * 0.30, rate: 0.6, cutoff: 55; sleep 0.5; else; sleep 0.5; end; else; sleep 12; end; end
